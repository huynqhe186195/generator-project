    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="dec" uri="http://www.opensymphony.com/sitemesh/decorator" %>
            ...
            <head>
                ...
                <title>
                    <dec:title default="Admin Dashboard" />
                </title>
                    ...
                    <div class="border-end bg-dark text-white" id="sidebar-wrapper" style="width: 250px;">
                        ...
                        <div class="list-group list-group-flush">
                            <c:if test="${currentUser.roleId == 2}">
                                <a href="<c:url value='/admin/user/dashboard'/>"
                            ...
                            <c:if test="${currentUser.roleId == 1 || currentUser.hasPermission('ROLE_VIEW')}">
                                <a href="<c:url value='/admin/role/role-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                            ...
                            <c:if test="${currentUser.roleId == 1 || currentUser.hasPermission('ROLE_VIEW')}">
                                <a href="<c:url value='/admin/requests'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                                    <i class="fas fa-bell me-2" style="width: 20px;"></i> Yêu cầu từ hệ thống
                                </a>
                            </c:if>
                            ...
                            <c:if test="${currentUser.roleId == 2}">
                                <a href="<c:url value='/admin/user/generator-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                            ...
                            <c:if test="${currentUser.roleId == 3 || currentUser.hasPermission('QUOTE_MANAGE')}">
                                <a href="<c:url value='/staff/incident-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                            ...
                            <c:if test="${currentUser.roleId == 3 }">
                                <a href="<c:url value='/staff/customer-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                                    <i class="fas fa-user-shield me-2" style="width: 20px;"></i> Xem danh sách khách
                                    hàng
                                </a>
                            </c:if>
                            <c:if test="${currentUser.roleId == 3 }">
                                <a href="<c:url value='/staff/repair-request-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                                    <i class="fas fa-user-shield me-2" style="width: 20px;"></i> Xem danh sách yêu cầu
                                    sửa chữa
                                </a>
                            </c:if>
                            <c:if test="${currentUser.roleId == 3 }">
                                <a href="<c:url value='/staff/invoice-list'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
                                    <i class="fas fa-user-shield me-2" style="width: 20px;"></i> xem hóa đơn
                                    <a href="<c:url value='/staff/customer-requests'/>"
                                        class="list-group-item list-group-item-action bg-transparent text-white p-3">
                                        <i class="fas fa-inbox me-2" style="width: 20px;"></i> Yêu cầu từ khách hàng
                                    </a>
                            </c:if>
                            <c:if test="${currentUser.roleId == 3 }">
                                <a href="<c:url value='/staff/contracts'/>"
                                    class="list-group-item list-group-item-action bg-transparent text-white p-3">
