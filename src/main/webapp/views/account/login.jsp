...
<head>
    ...
    <link rel="stylesheet"
          href="<c:url value='/template/account/fonts/material-icon/css/material-design-iconic-font.min.css'/>">
                ...
                <div class="signin-form">
                    ...
                    <form method="POST" action="<c:url value='/hanldeLogin'/>" class="register-form" id="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <a href="<c:url value='/account/forgot-password'/>" class="signup-image-link">Forgot
                                password!</a>
