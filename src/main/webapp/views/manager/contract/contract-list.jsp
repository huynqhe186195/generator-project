        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        <form action="contracts" method="get" class="d-flex gap-2">
                    ...
                    <div class="col-md-4 text-end">
                        ...
                        <a href="contracts?action=create_view" class="btn btn-outline-primary">
                    ...
                    <tbody>
                        <c:forEach var="c" items="${contracts}" varStatus="status">
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-light text-dark border">${c.productSerial}</span>
                                </td>
                                <td>${c.startDate}</td>
                                <td>${c.endDate}</td>
                                <td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="contracts?action=delete&id=${c.id}" class="btn btn-sm btn-danger"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info small">
                            ...
                            <ul class="mb-0 ps-3">
                                ...
                                <li>Phải có serial máy: <code>Serial: ...</code></li>
                            </ul>
                        </div>
                    </div>
