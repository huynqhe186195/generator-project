    ...
    <div class="accordion accordion-shell" id="capabilityAccordion">
        <div class="accordion-item section-card">
            <h2 class="accordion-header" id="headingTechnician">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTechnician" aria-expanded="true" aria-controls="collapseTechnician">
        ...
        <div class="accordion-item section-card">
            <h2 class="accordion-header" id="headingCatalog">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCatalog" aria-expanded="false" aria-controls="collapseCatalog">
                    <div class="section-head w-100 me-3">
                        <div>
                            <h2 class="section-title">Quản lý danh mục kỹ năng</h2>
                    ...
                    <div class="inner-card mt-2">
                        ...
                        <div class="inner-card-body">
                            <form method="post" action="${pageContext.request.contextPath}/manager/technician-capability" class="row g-3 mb-4 align-items-end">
                                ...
                                <input type="hidden" name="technicianId" value="${selectedTechnicianId}">
                                <div class="col-md-3">
                                    <label class="form-label">Mã kỹ năng</label>
                                        ...
                                        <tbody>
                                            <c:forEach items="${skillCatalog}" var="item">
                                                <tr>
                                                    ...
                                                    <td>${item.name}</td>
                                                    <td><span class="badge-soft ${item.activeStatus ? 'badge-soft-success' : 'badge-soft-muted'}">${item.activeStatus ? 'Hoạt động' : 'Ngừng hoạt động'}</span></td>
                                                </tr>
                                            </c:forEach>
                                            <c:if test="${empty skillCatalog}">
                                                <tr><td colspan="3" class="empty-state">Danh mục kỹ năng đang trống.</td></tr>
                                            </c:if>
                                        </tbody>
                                    </table>
                                </div>
