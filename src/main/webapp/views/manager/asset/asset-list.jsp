                            ...
                            <nav>
                                <ul class="pagination pagination-sm mb-0 justify-content-end">
                                    <li class="page-item ${ownershipCurrentPage == 1 ? 'disabled' : ''}">
                                        <a class="page-link" href="assets?action=list&ownershipPage=${ownershipCurrentPage - 1}&selectedModelId=${selectedModelId}"><i class="fa fa-chevron-left"></i></a>
                                    </li>
                                    <c:forEach begin="1" end="${ownershipTotalPages}" var="i">
                                        <li class="page-item ${ownershipCurrentPage == i ? 'active' : ''}">
                                            <a class="page-link" href="assets?action=list&ownershipPage=${i}&selectedModelId=${selectedModelId}">${i}</a>
                                        </li>
                                    </c:forEach>
                                    <li class="page-item ${ownershipCurrentPage == ownershipTotalPages ? 'disabled' : ''}">
                                        <a class="page-link" href="assets?action=list&ownershipPage=${ownershipCurrentPage + 1}&selectedModelId=${selectedModelId}"><i class="fa fa-chevron-right"></i></a>
                                    </li>
                                </ul>
                            </nav>
                        </c:if>
