                                ...
                                <div class="vstack gap-2">
                                    <c:forEach var="ownership" items="${productModelOwnerships}">
                                        <a class="ownership-card p-3 text-decoration-none ${selectedModelId == ownership.modelId ? 'active' : ''}"
                                           href="assets?action=list&ownershipPage=${ownershipCurrentPage}&selectedModelId=${ownership.modelId}">
                            ...
                            <nav>
                                <ul class="pagination pagination-sm mb-0 justify-content-end">
                                    <li class="page-item ${ownershipCurrentPage == 1 ? 'disabled' : ''}">
                                        <a class="page-link" href="assets?action=list&keyword=${currentKeyword}&ownershipPage=${ownershipCurrentPage - 1}&selectedModelId=${selectedModelId}"><i class="fa fa-chevron-left"></i></a>
                                    </li>

                                    <c:if test="${ownershipPageStart > 1}">
                                        <li class="page-item">
                                            <a class="page-link" href="assets?action=list&keyword=${currentKeyword}&ownershipPage=1&selectedModelId=${selectedModelId}">1</a>
                                        </li>
                                    ...
                                    <c:forEach begin="${ownershipPageStart}" end="${ownershipPageEnd}" var="i">
                                        <li class="page-item ${ownershipCurrentPage == i ? 'active' : ''}">
                                            <a class="page-link" href="assets?action=list&keyword=${currentKeyword}&ownershipPage=${i}&selectedModelId=${selectedModelId}">${i}</a>
                                        </li>
                                    </c:forEach>
                                    ...
                                    <c:if test="${ownershipPageEnd < ownershipTotalPages}">
                                        <li class="page-item disabled"><span class="page-link">...</span></li>
                                        <li class="page-item">
                                            <a class="page-link" href="assets?action=list&keyword=${currentKeyword}&ownershipPage=${ownershipTotalPages}&selectedModelId=${selectedModelId}">${ownershipTotalPages}</a>
                                        </li>
                                    </c:if>

                                    <li class="page-item ${ownershipCurrentPage == ownershipTotalPages ? 'disabled' : ''}">
                                        <a class="page-link" href="assets?action=list&keyword=${currentKeyword}&ownershipPage=${ownershipCurrentPage + 1}&selectedModelId=${selectedModelId}"><i class="fa fa-chevron-right"></i></a>
                                    </li>
                                </ul>
                            </nav>
                        </c:if>
