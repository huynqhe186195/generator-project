                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty requests}">
                                <tr>
                                    <td colspan="6" class="text-center">Bạn chưa gửi yêu cầu nào.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
                    ...
                    <div class="modal-content">
                        <form action="requests" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Email khách hàng <span
                                ...
                                <div class="alert alert-info small">
                                    <i class="fa fa-info-circle"></i> Sau khi Admin duyệt, mật khẩu sẽ được gửi tự động
                                    vào email này.
                                </div>
                            </div>
