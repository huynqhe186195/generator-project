        ...
        <section class="news-hero">
          <div class="container news-hero-content">
            ...
            <p class="news-hero-desc">
              Theo dõi các bài viết, thông báo, hoạt động nổi bật và những thông tin mới nhất liên quan đến hệ thống
              quản trị máy phát điện.
            </p>
          </div>
        </section>
                ...
                <form method="get" action="${ctx}/news" class="row g-3 align-items-end">
                  <div class="col-lg-6">
                    ...
                    <input type="text" name="keyword" class="form-control filter-input"
                      placeholder="Tìm theo tiêu đề bài viết hoặc tên tác giả..." value="${param.keyword}">
                  </div>
                      ...
                      <div class="news-content">
                        <div class="news-meta">
                          <span>
                            ...
                            Ngày đăng:
                            <fmt:formatDate value="${n.publishedAt != null ? n.publishedAt : n.createdAt}"
                              pattern="dd/MM/yyyy" />
                          </span>
