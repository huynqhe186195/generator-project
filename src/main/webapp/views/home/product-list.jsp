                ...
                <body>
                                ...
                                <ul class="navbar-nav ms-auto align-items-center">
                                    <li class="nav-item">
                                        <a class="nav-link px-3"
                                            href="<c:url value='/views/home/DetailCompany.jsp'/>">Sơ lược công ty</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link nav-pill px-3" href="<c:url value='/news'/>">Tin tức</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link nav-pill px-3" href="<c:url value='/products'/>">Sản phẩm
                                            mẫu</a>
                                    </li>
                                    <c:if test="${not empty user}">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-3"
                                                href="<c:url value='/views/home/Support.jsp'/>">Chăm sóc khách hàng</a>
                                        </li>
                                    </c:if>
                                    ...
                                    <c:choose>
                                        <c:when test="${empty user}">
                                            <li class="nav-item ms-lg-3">
                                                <a href="<c:url value='/account/login'/>" class="btn btn-white">Đăng
                                                    nhập</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-3">
                                                    <li>
                                                        <a class="dropdown-item py-2"
                                                            href="<c:url value='/account/user-profile'/>">
                                                            <i class="fas fa-id-card me-2"></i>Hồ sơ
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item py-2"
                                                            href="<c:url value='/account/hanldeChangePassword'/>">
                    ...
                    <section class="hero-section">
                        <div class="container position-relative" data-aos="fade-right">
                            ...
                            <p class="hero-desc">Khách hàng không xem danh sách toàn bộ hợp đồng. Để xem chi tiết, vui
                                lòng nhập chính xác mã hợp đồng đang sở hữu để tra cứu thông tin hợp đồng và các thiết
                                bị thuộc hợp đồng đó.</p>
                        </div>
                    </section>
                    ...
                    <main>
                        <div class="container" data-aos="fade-up">
                            <div class="lookup-card mb-4">
                                <div
                                    class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center mb-3">
                                    <div>
                                        <h5 class="section-title mb-2"><i class="fas fa-magnifying-glass"></i> Nhập mã
                                            hợp đồng</h5>
                                        <p class="section-sub mb-0">Hệ thống chỉ hiển thị hợp đồng khi mã hợp đồng chính
                                            xác và thuộc quyền sở hữu của bạn.</p>
                                    </div>
                                </div>
                                ...
                                <form method="get" action="<c:url value='/product-list'/>" class="lookup-form">
                                    <div>
                                        ...
                                        <input type="text" name="contractNumber" class="form-control form-control-lg"
                                    ...
                                    <a class="btn btn-outline-secondary btn-pill btn-lg"
                            ...
                            <c:if test="${lookupPerformed and empty lookupError and not empty contract}">
                                <div class="main-card mb-4">
                                    <div class="card-header-soft">
                                        <h5 class="section-title"><i class="fas fa-file-contract"></i> Thông tin hợp
                                            đồng</h5>
                                    ...
                                    <div class="detail-grid">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div class="value">${not empty contract.customerName ? contract.customerName
                                                : user.fullName}</div>
                                        </div>
                                        <div class="detail-item">
                                            ...
                                            <div class="value">
                                                <c:choose>
                                                    <c:when test="${contract.status == 'ACTIVE'}">
                                                        <span
                                                            class="status-badge bg-success bg-opacity-10 text-success"><i
                                                                class="fas fa-circle-check"></i>Đang hiệu lực</span>
                                                    </c:when>
                                                    <c:when test="${contract.status == 'PENDING_SERIAL'}">
                                                        <span
                                                            class="status-badge bg-warning bg-opacity-10 text-warning"><i
                                                                class="fas fa-hourglass-half"></i>Chờ gán thiết
                                                            bị</span>
                                                    </c:when>
                                                    <c:when test="${contract.status == 'TERMINATED'}">
                                                        <span
                                                            class="status-badge bg-danger bg-opacity-10 text-danger"><i
                                                                class="fas fa-circle-xmark"></i>Đã chấm dứt</span>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span
                                                            class="status-badge bg-secondary bg-opacity-10 text-secondary"><i
                                                                class="fas fa-circle-info"></i>${contract.status}</span>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        </div>
                                            ...
                                            <div class="value">
                                                <c:choose>
                                                    <c:when test="${not empty contract.signedDate}">
                                                        <fmt:formatDate value="${contract.signedDate}"
                                                            pattern="dd/MM/yyyy" />
                                                    </c:when>
                                                    ...
                                                    <c:when test="${not empty contract.filePath}">
                                                        <div class="d-flex flex-wrap gap-2">
                                                            ...
                                                            <a class="btn btn-sm btn-primary btn-pill"
                                                                href="<c:url value='/${contract.filePath}'/>" download>
                                ...
                                <div class="main-card">
                                    <div class="card-header-soft">
                                        <h5 class="section-title"><i class="fas fa-microchip"></i> Thiết bị thuộc hợp
                                            đồng</h5>
                                        <p class="section-sub">Danh sách thiết bị, thông tin vận hành và các hành động
                                            liên quan đến từng thiết bị trong hợp đồng này.</p>
                                    </div>
                                        ...
                                        <c:choose>
                                                    ...
                                                    <c:forEach items="${contractDevices}" var="p">
                                                        <div class="device-card" role="button" tabindex="0"
                                                            ...
                                                            <div class="device-head">
                                                                <div>
                                                                    <div class="serial-pill mb-3"><i
                                                                            class="fas fa-barcode"></i>${p.serialNumber}
                                                                    </div>
                                                                    <h6 class="device-name">${not empty p.modelName ?
                                                                        p.modelName : 'Chưa có tên model'}</h6>
                                                                    <div class="text-muted small mt-1">${not empty
                                                                        p.brandName ? p.brandName : 'Chưa cập nhật
                                                                        thương hiệu'}</div>
                                                                </div>
                                                                <c:choose>
                                                                    <c:when test="${p.status == 'RUNNING'}">
                                                                        <span
                                                                            class="badge bg-success-subtle text-success border border-success-subtle">Đang
                                                                            hoạt động</span>
                                                                    </c:when>
                                                                    <c:when test="${p.status == 'MAINTENANCE'}">
                                                                        <span
                                                                            class="badge bg-warning-subtle text-warning border border-warning-subtle">Đang
                                                                            bảo trì</span>
                                                                    </c:when>
                                                                    <c:when test="${p.status == 'BROKEN'}">
                                                                        <span
                                                                            class="badge bg-danger-subtle text-danger border border-danger-subtle">Hỏng
                                                                            hóc</span>
                                                                    </c:when>
                                                                    <c:when test="${p.status == 'RECEIVED_QUOTE'}">
                                                                        <span
                                                                            class="badge bg-primary-subtle text-primary border border-primary-subtle">Có
                                                                            báo giá</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <span
                                                                            class="badge bg-secondary-subtle text-secondary border border-secondary-subtle">${p.status}</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </div>
                                                            ...
                                                            <div class="info-list mb-4">
                                                                <div class="info-row">
                                                                    ...
                                                                    <span class="info-value">${not empty
                                                                        p.currentLocation ? p.currentLocation : 'Chưa
                                                                        cập nhật'}</span>
                                                                </div>
                                                                <div class="info-row">
                                                                    <span class="info-label">Năm sản xuất</span>
                                                                    <span class="info-value">${p.manufactureYear != null
                                                                        ? p.manufactureYear : 'Chưa cập nhật'}</span>
                                                                </div>
                                                                <div class="info-row">
                                                                ...
                                                                <div class="info-row">
                                                                    ...
                                                                    <span class="info-value">${p.totalRunningHours !=
                                                                        null ? p.totalRunningHours : 0} giờ</span>
                                                                </div>
                                                            </div>

                                                            <div
                                                                class="text-primary fw-bold small d-flex align-items-center gap-2 mt-4">
                                            ...
                                            <c:otherwise>
                                                <div class="text-center text-muted py-5">
                                                    ...
                                                    <p class="mb-1 fw-bold">Hợp đồng này hiện chưa có thiết bị nào được
                                                        gán.</p>
                                                    <small>Vui lòng liên hệ bộ phận quản lý nếu bạn cần kiểm tra
                                                        thêm.</small>
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
                            ...
                            <c:if test="${not lookupPerformed}">
                                <div class="main-card p-5 text-center text-muted">
                                    ...
                                    <p class="mb-0">Hãy nhập mã hợp đồng ở phía trên để xem thông tin chi tiết hợp đồng
                                        và toàn bộ thiết bị liên quan.</p>
                                </div>
                            </c:if>
                        </div>
                    </main>
                            ...
                            <div class="modal-content border-0 shadow-lg">
                                <div class="modal-header bg-primary text-white">
                                    <div>
                                        ...
                                        <div class="small mt-1">Serial: <span class="font-monospace fw-bold"
                                                id="deviceDetailSerial"></span></div>
                                    </div>
                                ...
                                <form action="<c:url value='/report-incident'/>" method="POST">
                                    ...
                                    <div class="modal-body p-4">
                                        <div class="alert alert-warning d-flex align-items-center" role="alert">
                                            ...
                                            <div>
                                                <div class="small text-uppercase fw-bold opacity-75">Thiết bị gặp lỗi:
                                                </div>
                                                <div class="fs-5 fw-bold text-dark" id="modalProductName"></div>
                                                <div class="small">Serial: <span class="font-monospace fw-bold"
                                                        id="modalProductSerial"></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Loại sự cố <span
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Khung giờ khách có thể tiếp nhận kiểm
                                                    tra</label>
                                            ...
                                            <div class="col-12">
                                                <label class="form-label fw-bold">Tiêu đề ngắn <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control"
                                                    placeholder="VD: Máy không đề nổ được..." required>
                                            </div>

                                            <div class="col-12">
                                                <label class="form-label fw-bold">Mô tả chi tiết</label>
                                                <textarea name="description" class="form-control" rows="4"
                                                    placeholder="Mô tả kỹ hơn về hiện tượng..."></textarea>
                                            </div>
                                        </div>
                                    </div>
