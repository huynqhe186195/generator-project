            ...
            <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto align-items-center">
                                <li class="nav-item">
                                    <a class="nav-link px-3" href="<c:url value='/views/home/DetailCompany.jsp'/>">Sơ
                                        lược công ty</a>
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link px-3" href="<c:url value='/'/>#features">Tính
                                        năng</a></li>
                                <li class="nav-item"><a class="nav-link px-3" href="<c:url value='/'/>#brands">Thương
                                        hiệu</a></li>

                                <c:if test="${not empty user}">
                                    <li class="nav-item">
                                        <a class="nav-link px-3" href="<c:url value='/views/home/Support.jsp'/>">Chăm
                                            sóc khách hàng</a>
                                    </li>
                                </c:if>
                ...
                <section class="hero-section">
                    <div class="container position-relative" data-aos="fade-right">
                        ...
                        <p class="hero-desc">
                            Quản lý, theo dõi và tra cứu thiết bị nhanh — lọc theo thương hiệu hoặc tìm theo tên máy /
                            serial.
                        </p>
                    </div>
                </section>
                                ...
                                <form method="get" action="<c:url value='/product-list'/>">
                                    <div class="filter-grid">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-select" name="brandId">
                                                ...
                                                <c:forEach items="${brands}" var="b">
                                                    <option value="${b.id}" ${brandId !=null && brandId==b.id
                                                        ? 'selected' : '' }>
                                                        ${b.name}
                                                    </option>
                                                </c:forEach>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a class="btn btn-outline-secondary btn-pill w-100"
                                    ...
                                    <tbody>
                                        <c:forEach items="${products}" var="p">
                                            <tr>
                                                <td class="ps-3">
                                                    <span
                                                        class="fw-bold text-dark font-monospace">${p.serialNumber}</span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="meta text-muted small">
                                                        ...
                                                        <c:if test="${not empty p.currentLocation}">
                                                            &nbsp;•&nbsp; <i
                                                                class="fas fa-map-marker-alt me-1"></i>${p.currentLocation}
                                                        </c:if>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${p.status == 'RUNNING'}">
                                                            <span
                                                                class="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-2">Đang
                                                                hoạt động</span>
                                                        </c:when>
                                                        <c:when test="${p.status == 'BROKEN'}">
                                                            <span
                                                                class="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3 py-2">Hỏng
                                                                hóc</span>
                                                        </c:when>
                                                        ...
                                                        <%-- THÊM MỚI: Trạng thái Đã nhận báo giá --%>
                                                            <c:when test="${p.status == 'RECEIVED_QUOTE'}">
                                                                <span
                                                                    ...
                                                                    <i class="fas fa-file-invoice-dollar me-1"></i>Có
                                                                    báo giá mới
                                                                </span>
                                                            </c:when>
                                                            ...
                                                            <c:otherwise>
                                                                <span
                                                                    class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3 py-2">${p.status}</span>
                                                            </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${p.contractStatus == 'TERMINATED'}">
                                                                        <div class="dropdown terminated-dropdown">
                                                                            <button
                                                                                class="btn btn-sm btn-danger btn-pill px-3 dropdown-toggle"
                                                                            ...
                                                                            <div class="collapse"
                                                                                id="terminatedDetail-${p.id}">
                                                                                <div class="terminated-meta">
                                                                                    <c:if
                                                                                        test="${not empty p.latestTerminatedEvent}">
                                                                                        <div class="mt-1"><strong>Lý
                                                                                                do:</strong>
                                                                                            ${p.latestTerminatedEvent}
                                                                                        </div>
                                                                                    </c:if>
                                                                                    <c:if
                                                                                        test="${not empty p.terminatedAt}">
                                                                                        <div class="mt-1">
                                                                                            <strong>Hủy lúc:</strong>
                                                                                            <fmt:formatDate
                                                                                                value="${p.terminatedAt}"
                                                                        ...
                                                                        <span data-bs-toggle="tooltip"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                disabled>
                                                                                <i
                                                                                    class="fas fa-triangle-exclamation me-1"></i>Báo
                                                                                sự cố
                                                                            </button>
                                                                        </span>
                                                                        <span data-bs-toggle="tooltip"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                disabled>
                                                                                <i
                                                                                    class="fas fa-file-invoice-dollar me-1"></i>Xem
                                                                                báo giá
                                                                            </button>
                                                                        </span>
                                                                    </c:when>
                                                                        ...
                                                                        <%-- Đang chờ xử lý -> Nút Disable --%>
                                                                            <c:when test="${p.status == 'MAINTENANCE'}">
                                                                                <button type="button"
                                                                                    ...
                                                                                    <i
                                                                                        class="fas fa-hourglass-half me-1"></i>Đã
                                                                                    báo cáo
                                                                                </button>
                                                                            </c:when>
                                    ...
                                    <nav>
                                        <ul class="pagination justify-content-end mb-0">
                                            ...
                                            <li class="page-item ${currentPage <= 1 ? 'disabled' : ''}">
                                                <a class="page-link" href="<c:url value='/product-list'>
