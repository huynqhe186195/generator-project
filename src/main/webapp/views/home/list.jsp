                        ...
                        <div class="hero-box">
                            <div class="row align-items-center g-4">
                                <div class="col-lg-8">
                                    ...
                                    <p class="hero-desc">
                                        Trang trưng bày sản phẩm dành cho khách tham quan và người dùng, giúp xem nhanh
                                        thông tin cơ bản,
                                ...
                                <div class="col-lg-4">
                                    <div class="row g-3">
                                        <div class="col-6">
                                            <div
                                                class="bg-white bg-opacity-10 border border-light border-opacity-25 rounded-4 text-center py-3 px-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" name="keyword" class="form-control"
                                                placeholder="Tên máy, hãng, danh mục..." value="${param.keyword}">
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            ...
                                            <select name="brandId" class="form-select">
                                                ...
                                                <c:forEach var="b" items="${brands}">
                                                    <option value="${b.id}" ${param.brandId==b.id.toString()
                                                        ? 'selected' : '' }>
                                                        ${b.name}
                                                    </option>
                                                </c:forEach>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            ...
                                            <select name="categoryId" class="form-select">
                                                ...
                                                <c:forEach var="c" items="${categories}">
                                                    <option value="${c.id}" ${param.categoryId==c.id.toString()
                                                        ? 'selected' : '' }>
                                                        ${c.name}
                                                    </option>
                                                </c:forEach>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            ...
                                            <select name="fuelType" class="form-select">
                                                <option value="">Tất cả</option>
                                                <option value="Diesel" ${param.fuelType=='Diesel' ? 'selected' : '' }>
                                                    Diesel</option>
                                                <option value="Gasoline" ${param.fuelType=='Gasoline' ? 'selected' : ''
                                                    }>Gasoline</option>
                                                <option value="Gas" ${param.fuelType=='Gas' ? 'selected' : '' }>Gas
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            ...
                                            <input type="number" min="0" name="powerMin" class="form-control"
                                                placeholder="VD: 100" value="${param.powerMin}">
                                        </div>

                                        <div class="col-md-6 col-lg-2">
                                            <label class="filter-label">Đến</label>
                                            <input type="number" min="0" name="powerMax" class="form-control"
                                                placeholder="VD: 500" value="${param.powerMax}">
                                        </div>
                                        ...
                                        <div class="col-12 d-flex flex-wrap gap-2 mt-2">
                                            ...
                                            <a href="${ctx}/products"
                                                class="btn btn-outline-secondary btn-outline-custom">
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <div class="product-desc">
                                                        <c:choose>
                                                            <c:when test="${not empty item.description}">
                                                                ${fn:length(item.description) > 120 ?
                                                                fn:substring(item.description, 0, 120).concat('...') :
                                                                item.description}
                                                            </c:when>
                                                            <c:otherwise>
                                                                Mẫu máy phát điện phù hợp cho nhu cầu vận hành, dự phòng
                                                                và tham khảo thông số kỹ thuật cơ bản.
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                    ...
                                                    <div class="product-footer">
                                                        ...
                                                        <a href="${ctx}/products/detail?id=${item.id}"
