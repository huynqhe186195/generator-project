        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-lg-1">
              ...
              <li class="nav-item"><a class="nav-link nav-pill px-3" href="<c:url value='/products'/>">Sản phẩm mẫu</a>
              </li>
                ...
                <c:otherwise>
                  <li class="nav-item dropdown ms-lg-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-3">
                      ...
                      <li><a class="dropdown-item py-2" href="<c:url value='/account/hanldeChangePassword'/>"><i
        ...
        <div class="container position-relative" style="z-index:1;">
          <div class="row align-items-center g-4">
            <div class="col-lg-7" data-aos="fade-right">
              ...
              <p class="hero-desc">
                Giải pháp số hoá quản trị máy phát điện, giúp theo dõi thiết bị, lịch bảo trì và vận hành tập trung —
                nhanh, chuẩn, dễ mở rộng.
              </p>
            ...
            <div class="col-lg-5 d-none d-lg-block" data-aos="zoom-in">
              <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=1100&q=80"
                class="img-fluid hero-img" alt="Gen-CMS Overview">
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="soft-card">
                <div class="soft-card-body">
                  ...
                  <ul class="feature-list">
                    <li><i class="fa-solid fa-circle-check"></i><span>Quản lý danh mục máy phát, thương hiệu và thông số
                        vận hành.</span></li>
                    <li><i class="fa-solid fa-circle-check"></i><span>Theo dõi lịch bảo trì, lịch sử sửa chữa và báo cáo
                        sự cố.</span></li>
                    <li><i class="fa-solid fa-circle-check"></i><span>Phân quyền người dùng theo vai trò
                        (Admin/Manager/Technician...).</span></li>
                    <li><i class="fa-solid fa-circle-check"></i><span>Hỗ trợ mở rộng tích hợp dữ liệu/thiết bị theo từng
                        giai đoạn.</span></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="100">
              <div class="soft-card text-center">
                <div class="soft-card-body">
                  ...
                  <p class="small mb-0" style="color: var(--muted);">Quản lý tài khoản, danh mục máy phát và cấu hình
                    toàn hệ thống.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
              <div class="soft-card text-center">
                <div class="soft-card-body">
                  ...
                  <p class="small mb-0" style="color: var(--muted);">Cập nhật bảo trì, tạo báo cáo sự cố và theo dõi
                    lịch sử sửa chữa.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="300">
              <div class="soft-card text-center">
                <div class="soft-card-body">
                  ...
                  <p class="small mb-0" style="color: var(--muted);">Giám sát tổng thể và xem báo cáo phân tích vận
                    hành.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
              <div class="soft-card text-center">
                <div class="soft-card-body">
                  ...
                  <p class="small mb-0" style="color: var(--muted);">Lưu trữ tập trung dữ liệu thiết bị, người dùng và
                    lịch sử hoạt động.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row justify-content-center text-center">
              <div class="col-lg-10">
                ...
                <p class="lead mb-4" style="color: rgba(15,23,42,.72);">
                  Dữ liệu được luân chuyển qua việc nhập liệu, cập nhật và truy xuất trực tiếp từ người dùng trên giao
                  diện web.
                </p>
