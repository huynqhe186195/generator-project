<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
      ...
      <c:set var="qs"
        value="&keyword=${fn:escapeXml(param.keyword)}&brandId=${fn:escapeXml(param.brandId)}&categoryId=${fn:escapeXml(param.categoryId)}&fuelType=${fn:escapeXml(param.fuelType)}&power=${fn:escapeXml(param.power)}&status=${fn:escapeXml(param.status)}" />
          ...
          <div class="card-body bg-light border-radius-12">
            <form action="${ctx}/it/products" method="get" class="row g-2 align-items-end">
              ...
              <div class="col-md-1">
                ...
                <input type="number" step="0.01" name="power" value="${fn:escapeXml(param.power)}"
