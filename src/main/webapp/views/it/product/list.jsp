...
<c:set var="qs"
  value="&keyword=${fn:escapeXml(param.keyword)}&brandId=${fn:escapeXml(param.brandId)}&categoryId=${fn:escapeXml(param.categoryId)}&fuelType=${fn:escapeXml(param.fuelType)}&powerMin=${fn:escapeXml(param.powerMin)}&powerMax=${fn:escapeXml(param.powerMax)}&status=${fn:escapeXml(param.status)}" />
    ...
    <div class="card-body bg-light border-radius-12">
      <form action="${ctx}/it/products" method="get" class="row g-2 align-items-end">
        ...
        <div class="col-md-1">
          ...
          <input type="number" step="0.01" min="0" name="powerMax"
            value="${fn:escapeXml(param.powerMax)}"
            ...
            <ul class="pagination pagination-sm mb-0">
              ...
              <c:if test="${endPage < totalPages}">
                ...
                <li class="page-item"><a class="page-link"
                    href="${ctx}/it/products?page=${totalPages}${qs}">${totalPages}</a></li>
              </c:if>
