...
<div class="container mt-4">
  ...
  <div class="row justify-content-center">
    <div class="col-md-9"> <div class="card shadow-lg border-0 rounded-3">
      ...
      <div class="card-body p-4">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6 mt-4">
            ...
            <div>${user.status == 1 ? '<span class="text-success fw-bold">Hoạt động</span>' : '<span class="text-danger">Đã khóa</span>'}</div>
          </div>
        </div>
      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="small">
                        ...
                        <div class="text-danger"><i class="fas fa-calendar-times me-1"></i>End: <fmt:formatDate value="${contract.endDate}" pattern="dd/MM/yyyy"/></div>
                      </div>
                    </td>
                    <td>
                      <c:choose>
                        <c:when test="${contract.status == 'ACTIVE'}">
                          <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill">Đang hiệu lực</span>
                        </c:when>
                        <c:when test="${contract.status == 'EXPIRED'}">
                          <span class="badge bg-secondary bg-opacity-10 text-secondary px-3 py-2 rounded-pill">Hết hạn</span>
                        </c:when>
